...
class RoutePointsControllerTest < ActionController::TestCase
  ...
  test "should create route_point" do
    assert_difference('RoutePoint.count') do
      post :create, route_point: { coordinate_id: @route_point.coordinate_id, point_order: @route_point.point_order, route_id: @route_point.route_id }
    end
  ...
  test "should update route_point" do
    patch :update, id: @route_point, route_point: { coordinate_id: @route_point.coordinate_id, point_order: @route_point.point_order, route_id: @route_point.route_id }
    assert_redirected_to route_point_path(assigns(:route_point))
  end
